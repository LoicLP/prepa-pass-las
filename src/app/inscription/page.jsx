  ...
  return (
    <div className="min-h-screen bg-[#f0f4ff] flex items-center justify-center px-4 py-24 relative overflow-hidden">
      ...
      <div className="w-full max-w-[440px] bg-white rounded-3xl shadow-xl shadow-primary-900/[0.06] p-8 sm:p-10 relative z-10">
        ...
        {/* Titre */}
        <h1 className="text-2xl font-black text-gray-900 text-center mb-1">Créez votre compte</h1>
        <p className="text-sm text-gray-400 text-center mb-8">et commencez votre préparation en santé.</p>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <input
                ...
                placeholder="Dupont"
                className="w-full px-4 py-3.5 bg-primary-50/60 border border-primary-100 rounded-xl text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent focus:bg-white transition-all"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-11 pr-4 py-3.5 border rounded-xl text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent focus:bg-white transition-all ${
        ...
        <p className="mt-8 text-center text-sm text-gray-400">
          Déjà un compte ?{' '}
          <Link href="/connexion" className="text-primary-600 hover:text-primary-700 font-bold hover:underline">
            Se connecter
          </Link>
        </p>
      </div>
