...
export const FAC_EXAMS = {
  ...
  antilles: {
    formats: { propositions: 5 },
    exams: ['chimie', 'biocell', 'biophysique', 'biostats', 'anatomie', 'ssh'].map((s) => ({ subject: s, label: 'UE santé', questions: 25, minutes: 30, coeff: 1, format: 'qcm' })),
  },
  reunion: {
    formats: { propositions: 5 },
    exams: ['chimie', 'biocell', 'biophysique', 'biostats', 'anatomie', 'ssh'].map((s) => ({ subject: s, label: 'UE santé', minutes: 60, format: 'qcm' })),
  },
  ...
  angers: {
    ...
    exams: ['chimie', 'biocell', 'biophysique', 'biostats', 'anatomie', 'ssh'].map((s) => ({ subject: s, label: 'UE tronc commun PluriPASS', questions: 40, minutes: 60, format: 'qcm' })),
  },
  brest: {
    formats: { propositions: 5 },
  ...
  poitiers: {
    formats: { propositions: 5 },
    exams: ['chimie', 'biocell', 'biophysique', 'biostats', 'anatomie', 'ssh'].map((s) => ({ subject: s, label: 'UE santé (LAS)', questions: 40, minutes: 90, format: 'qcm' })),
  },
  limoges: {
    formats: { propositions: 5 },
    exams: [
